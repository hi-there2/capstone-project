...
function setup() {
  ...
  board1 = new Board(width - 300, 330, 100, 100);
  board2 = new Board(width - 550, height - 300, 100, 100);
}
...
function keyPressed() {
  if (keyCode === 32) {
    if (numberOfArrows > 0) {
      ...
      var arrow = new PlayerArrow(posX, posY, 50, 50, angle);
  ...
  swal(
    {
      ...
      imageUrl:
        "https://github.com/hi-there2/bjfr/assets/hammer.png",
      imageSize: "150x150",
